...
abbr -a gha 'GITHUB_TOKEN=$__GITHUB_TOKEN'
abbr -a gl glooctl
abbr -a glog 'git log'
abbr -a gp 'git p'
...
abbr -a mu 'multipass'
abbr -a mul 'multipass launch --bridged --name primary daily:26.10'
...
abbr -a pn pnpm
abbr -a pna 'pnpm add'
abbr -a pnab 'pnpm approve-builds'
abbr -a pnd 'pnpm dev'
...
abbr -a pnx 'pnpm dlx'
abbr -a po 'git add -A . && oco --fgm --yes'
abbr -a pp 'cco -ay && push'
abbr -a ppo 'git add -A . && oco --fgm --yes && push'
