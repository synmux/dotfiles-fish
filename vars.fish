set -gx __AQUA_API_KEY $__AVALON_API_KEY
set -gx CF_API_EMAIL $CLOUDFLARE_EMAIL
set -gx __CF_API_KEY $__CLOUDFLARE_API_KEY
...
set -gx __NAS_S3_SECRET $__NAS_OPENSTACK_SECRET
...
set -gx __SEMGREP_API_KEY $__SEMGREP_APP_TOKEN
...
set -gx __UPLOADTHING_TOKEN $__UPLOADTHING_API_KEY
