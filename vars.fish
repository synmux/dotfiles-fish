set -gx AQUA_API_KEY $__AVALON_API_KEY
set -gx CF_API_EMAIL $CLOUDFLARE_EMAIL
set -gx CF_API_KEY $__CLOUDFLARE_API_KEY
...
set -gx JEV_API_KEY $__TYPESAFE_API_KEY
...
set -gx NAS_S3_SECRET $__NAS_OPENSTACK_SECRET
set -gx NAS_S3_USERNAME_SUFFIX $__NAS_OPENSTACK_USERNAME_SUFFIX
...
set -gx SEMGREP_API_KEY $__SEMGREP_APP_TOKEN
...
set -gx UPLOADTHING_TOKEN $__UPLOADTHING_API_KEY
