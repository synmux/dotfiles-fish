...
complete -c otty -n "__fish_otty_needs_command" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_needs_command" -f -a "ssh" -d 'Inspect SSH remotes for terminfo entries Otty installed'
...
complete -c otty -n "__fish_otty_using_subcommand open" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand config; and not __fish_seen_subcommand_from show path get set unset edit validate reload help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand config; and __fish_seen_subcommand_from show" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand config; and __fish_seen_subcommand_from path" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand config; and __fish_seen_subcommand_from get" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand config; and __fish_seen_subcommand_from set" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand config; and __fish_seen_subcommand_from unset" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand config; and __fish_seen_subcommand_from edit" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand config; and __fish_seen_subcommand_from validate" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand config; and __fish_seen_subcommand_from reload" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand font; and not __fish_seen_subcommand_from list apply import help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand font; and __fish_seen_subcommand_from list" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand font; and __fish_seen_subcommand_from apply" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand font; and __fish_seen_subcommand_from import" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand theme; and not __fish_seen_subcommand_from list import help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand theme; and __fish_seen_subcommand_from list" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand theme; and __fish_seen_subcommand_from import" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand keybind; and not __fish_seen_subcommand_from list help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand keybind; and __fish_seen_subcommand_from list" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand window; and not __fish_seen_subcommand_from show list new close focus rename help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand window; and __fish_seen_subcommand_from show" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand window; and __fish_seen_subcommand_from list" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand window; and __fish_seen_subcommand_from new" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand window; and __fish_seen_subcommand_from close" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand window; and __fish_seen_subcommand_from focus" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand window; and __fish_seen_subcommand_from rename" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand tab; and not __fish_seen_subcommand_from show list new close focus rename move badge help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand tab; and __fish_seen_subcommand_from show" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand tab; and __fish_seen_subcommand_from list" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand tab; and __fish_seen_subcommand_from new" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand tab; and __fish_seen_subcommand_from close" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand tab; and __fish_seen_subcommand_from focus" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand tab; and __fish_seen_subcommand_from rename" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand tab; and __fish_seen_subcommand_from move" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand tab; and __fish_seen_subcommand_from badge" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -l format -d 'Output format' -r -f -a "text\t''
json\t''"
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -l socket -d 'Override runtime control socket path' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -l config-file -d 'Override config file path' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -l json -d 'Shortcut for --format json'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -l no-headers -d 'Suppress table headers in text list output'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -s q -l quiet -d 'Suppress non-essential success output'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -s y -l yes -d 'Skip destructive-action confirmation prompts'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -s h -l help -d 'Print help'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "show" -d 'Show one pane'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "list" -d 'List panes'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "split" -d 'Split a pane'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "close" -d 'Close a pane'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "focus" -d 'Focus a pane'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "zoom" -d 'Toggle zoom on a pane'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "resize" -d 'Resize a pane'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "send-keys" -d 'Send keys to a pane'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "send-text" -d 'Send raw text/bytes to a pane, no key-name vocabulary'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "run" -d 'Run a command in the pane and block until it returns to a prompt, then print its (merged) output. Exits with the command\'s exit code. Requires OSC 133 shell integration in the pane'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "exec" -d 'Like `run`, but captures stdout and stderr separately (injects a `2>tmpfile` redirection). stderr is no longer a tty for the command'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "wait" -d 'Block until the selected pane (or every pane of a tab / window) is idle, then exit 0. A pane running an agent is idle when the agent reports `idle`; a plain shell pane is idle when no command is executing and it is back at a prompt (requires OSC 133 shell integration). Panes that can report neither are skipped'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "capture" -d 'Capture pane text'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "badge" -d 'Set or clear the badge on the pane\'s tab'
complete -c otty -n "__fish_otty_using_subcommand pane; and not __fish_seen_subcommand_from show list split close focus zoom resize send-keys send-text run exec wait capture badge help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from show" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from list" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from split" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from close" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from focus" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from zoom" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from resize" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-keys" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l pane -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l from-file -d 'Read the bytes from a file, verbatim (no escape interpretation)' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l format -d 'Output format' -r -f -a "text\t''
json\t''"
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l socket -d 'Override runtime control socket path' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l config-file -d 'Override config file path' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l stdin -d 'Read the text from stdin instead of the TEXT argument'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l no-escape -d 'Send TEXT/stdin verbatim, without interpreting backslash escapes'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l raw-newlines -d 'Send newlines exactly as given, instead of as "submit this line"'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l json -d 'Shortcut for --format json'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -l no-headers -d 'Suppress table headers in text list output'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -s q -l quiet -d 'Suppress non-essential success output'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -s y -l yes -d 'Skip destructive-action confirmation prompts'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from send-text" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from run" -l pane -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from run" -l format -d 'Output format' -r -f -a "text\t''
json\t''"
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from run" -l socket -d 'Override runtime control socket path' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from run" -l config-file -d 'Override config file path' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from run" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from run" -l json -d 'Shortcut for --format json'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from run" -l no-headers -d 'Suppress table headers in text list output'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from run" -s q -l quiet -d 'Suppress non-essential success output'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from run" -s y -l yes -d 'Skip destructive-action confirmation prompts'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from run" -s h -l help -d 'Print help'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from exec" -l pane -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from exec" -l format -d 'Output format' -r -f -a "text\t''
json\t''"
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from exec" -l socket -d 'Override runtime control socket path' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from exec" -l config-file -d 'Override config file path' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from exec" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from exec" -l json -d 'Shortcut for --format json'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from exec" -l no-headers -d 'Suppress table headers in text list output'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from exec" -s q -l quiet -d 'Suppress non-essential success output'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from exec" -s y -l yes -d 'Skip destructive-action confirmation prompts'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from exec" -s h -l help -d 'Print help'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l pane -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l tab -d 'Wait for every pane in this tab instead of a single pane' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l window -d 'Wait for every pane of every tab in this window' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l timeout-secs -d 'Give up after this many seconds (exit 9). 0 waits forever' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l settle-ms -d 'How long a pane must stay idle before it counts as finished. Covers the gap between submitting a command and the shell announcing it' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l format -d 'Output format' -r -f -a "text\t''
json\t''"
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l socket -d 'Override runtime control socket path' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l config-file -d 'Override config file path' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l json -d 'Shortcut for --format json'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -l no-headers -d 'Suppress table headers in text list output'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -s q -l quiet -d 'Suppress non-essential success output'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -s y -l yes -d 'Skip destructive-action confirmation prompts'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from wait" -s h -l help -d 'Print help'
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from capture" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from badge" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from help" -f -a "send-text" -d 'Send raw text/bytes to a pane, no key-name vocabulary'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from help" -f -a "run" -d 'Run a command in the pane and block until it returns to a prompt, then print its (merged) output. Exits with the command\'s exit code. Requires OSC 133 shell integration in the pane'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from help" -f -a "exec" -d 'Like `run`, but captures stdout and stderr separately (injects a `2>tmpfile` redirection). stderr is no longer a tty for the command'
complete -c otty -n "__fish_otty_using_subcommand pane; and __fish_seen_subcommand_from help" -f -a "wait" -d 'Block until the selected pane (or every pane of a tab / window) is idle, then exit 0. A pane running an agent is idle when the agent reports `idle`; a plain shell pane is idle when no command is executing and it is back at a prompt (requires OSC 133 shell integration). Panes that can report neither are skipped'
...
complete -c otty -n "__fish_otty_using_subcommand view" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand edit" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand watch" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand features; and not __fish_seen_subcommand_from list try help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand features; and __fish_seen_subcommand_from list" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand features; and __fish_seen_subcommand_from try" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -l format -d 'Output format' -r -f -a "text\t''
json\t''"
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -l socket -d 'Override runtime control socket path' -r
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -l config-file -d 'Override config file path' -r
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -l json -d 'Shortcut for --format json'
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -l no-headers -d 'Suppress table headers in text list output'
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -s q -l quiet -d 'Suppress non-essential success output'
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -s y -l yes -d 'Skip destructive-action confirmation prompts'
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -s h -l help -d 'Print help'
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -f -a "terminfo" -d 'Check remote hosts for a `~/.terminfo` entry shadowing the system one'
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -f -a "scan-argv" -d 'Split an ssh command line into its connection arguments and the remote command, for the shell-integration wrappers'
complete -c otty -n "__fish_otty_using_subcommand ssh; and not __fish_seen_subcommand_from terminfo scan-argv help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -l term -d 'Terminfo entry to check. Defaults to the TERM Otty sends' -r
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -l format -d 'Output format' -r -f -a "text\t''
json\t''"
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -l socket -d 'Override runtime control socket path' -r
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -l config-file -d 'Override config file path' -r
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -l clean -d 'Remove the entries that are provably safe to remove. Without it, this command only reports'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -l json -d 'Shortcut for --format json'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -l no-headers -d 'Suppress table headers in text list output'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -s q -l quiet -d 'Suppress non-essential success output'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -s y -l yes -d 'Skip destructive-action confirmation prompts'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from terminfo" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from scan-argv" -l format -d 'Output format' -r -f -a "text\t''
json\t''"
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from scan-argv" -l socket -d 'Override runtime control socket path' -r
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from scan-argv" -l config-file -d 'Override config file path' -r
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from scan-argv" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from scan-argv" -l json -d 'Shortcut for --format json'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from scan-argv" -l no-headers -d 'Suppress table headers in text list output'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from scan-argv" -s q -l quiet -d 'Suppress non-essential success output'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from scan-argv" -s y -l yes -d 'Skip destructive-action confirmation prompts'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from scan-argv" -s h -l help -d 'Print help (see more with \'--help\')'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from help" -f -a "terminfo" -d 'Check remote hosts for a `~/.terminfo` entry shadowing the system one'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from help" -f -a "scan-argv" -d 'Split an ssh command line into its connection arguments and the remote command, for the shell-integration wrappers'
complete -c otty -n "__fish_otty_using_subcommand ssh; and __fish_seen_subcommand_from help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c otty -n "__fish_otty_using_subcommand state" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand version" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand completions" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand jump; and not __fish_seen_subcommand_from add remove view ls import help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand jump; and __fish_seen_subcommand_from add" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand jump; and __fish_seen_subcommand_from remove" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand jump; and __fish_seen_subcommand_from view" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand jump; and __fish_seen_subcommand_from ls" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand jump; and __fish_seen_subcommand_from import" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand learn" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand ignore" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand import; and not __fish_seen_subcommand_from zoxide ghostty kitty alacritty theme help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand import; and __fish_seen_subcommand_from zoxide" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand import; and __fish_seen_subcommand_from ghostty" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand import; and __fish_seen_subcommand_from kitty" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand import; and __fish_seen_subcommand_from alacritty" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand import; and __fish_seen_subcommand_from theme" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand export; and not __fish_seen_subcommand_from ghostty kitty alacritty help" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand export; and __fish_seen_subcommand_from ghostty" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand export; and __fish_seen_subcommand_from kitty" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand export; and __fish_seen_subcommand_from alacritty" -l timeout -d 'IPC timeout in milliseconds. Defaults to 3000 for most commands; the blocking `pane run` / `pane exec` default to 600000 (10 min) when unset' -r
...
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "open" -d 'Launch a new Otty window'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "config" -d 'Manage configuration'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "font" -d 'List available fonts'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "theme" -d 'List available color themes'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "keybind" -d 'List keybindings'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "window" -d 'Manage windows (requires running app)'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "tab" -d 'Manage tabs (requires running app)'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "pane" -d 'Manage panes (requires running app)'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "view" -d 'Open a file or URL inside an Otty pane, read-only by default (requires running app)'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "edit" -d 'Open a file inside an Otty pane in edit mode (requires running app)'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "watch" -d 'Run a command with progress badge (spinning → finish/error badge)'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "features" -d 'Try terminal feature samples (colors, emoji, OSC sequences, images, …)'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "ssh" -d 'Inspect SSH remotes for terminfo entries Otty installed'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "state" -d 'Report an agent\'s lifecycle state (used by hooks and integrations). Invoked as `otty state:<kind> key=value ...` (e.g. `otty state:claude session-id=abc state=processing`)'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "version" -d 'Show version information'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "completions" -d 'Print a shell completion script to stdout'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "jump" -d 'Jump to a frecency-ranked directory (requires running app). Sends `cd <path>\\n` to the focused pane. Manage the jump database with `otty jump:add` / `jump:remove` / `jump:view` / `jump:ls` / `jump:import`'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "learn" -d 'Record a directory visit in the frecency database. With no argument, records the focused pane\'s current cwd. (`learn` is multi-semantic — see `__learn` below for the unrelated autocomplete HelpProbe.)'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "ignore" -d 'Undo `otty learn`. Forgets a per-folder command/script learned in the current dir if one matches exactly; otherwise black-lists a directory reference in the frecency DB (best-effort `zoxide remove <path>`) — by path shape, so a since-deleted folder still gets pruned. Tool specs learned from `--help` have no per-command undo'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "import" -d 'Import data into Otty: another terminal\'s config (ghostty / kitty / alacritty), zoxide frecency, or a font file via `otty import <path-or-url>` (.ttf / .otf / .ttc / .otc)'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "export" -d 'Export the current Otty config to another terminal\'s format (ghostty / kitty / alacritty). Default is stdout — use `-o <path>` to write to a file'
complete -c otty -n "__fish_otty_using_subcommand help; and not __fish_seen_subcommand_from open config font theme keybind window tab pane view edit watch features ssh state version completions jump learn ignore import export help" -f -a "help" -d 'Print this message or the help of the given subcommand(s)'
...
complete -c otty -n "__fish_otty_using_subcommand help; and __fish_seen_subcommand_from pane" -f -a "send-text" -d 'Send raw text/bytes to a pane, no key-name vocabulary'
complete -c otty -n "__fish_otty_using_subcommand help; and __fish_seen_subcommand_from pane" -f -a "run" -d 'Run a command in the pane and block until it returns to a prompt, then print its (merged) output. Exits with the command\'s exit code. Requires OSC 133 shell integration in the pane'
complete -c otty -n "__fish_otty_using_subcommand help; and __fish_seen_subcommand_from pane" -f -a "exec" -d 'Like `run`, but captures stdout and stderr separately (injects a `2>tmpfile` redirection). stderr is no longer a tty for the command'
complete -c otty -n "__fish_otty_using_subcommand help; and __fish_seen_subcommand_from pane" -f -a "wait" -d 'Block until the selected pane (or every pane of a tab / window) is idle, then exit 0. A pane running an agent is idle when the agent reports `idle`; a plain shell pane is idle when no command is executing and it is back at a prompt (requires OSC 133 shell integration). Panes that can report neither are skipped'
...
complete -c otty -n "__fish_otty_using_subcommand help; and __fish_seen_subcommand_from ssh" -f -a "terminfo" -d 'Check remote hosts for a `~/.terminfo` entry shadowing the system one'
complete -c otty -n "__fish_otty_using_subcommand help; and __fish_seen_subcommand_from ssh" -f -a "scan-argv" -d 'Split an ssh command line into its connection arguments and the remote command, for the shell-integration wrappers'
